  ...
  switch (action.type) {
    ...
    case ADD_GEBREK:
      ...
      if (!["ernstig", "serieus", "gering"].includes(category)) {
        ...
        dispatch({
          ...
          payload: `Onbekende categorie: ${category}`,
        });
        return state;
      }
      ...
      if (state.newElement.gebreken[category].includes(gebrekName)) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Gebrek "${gebrekName}" is al toegevoegd onder ${category}.`,
        });
        return state;
      }
    ...
    case REMOVE_GEBREK:
      ...
      if (!["ernstig", "serieus", "gering"].includes(remCategory)) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Onbekende categorie: ${remCategory}`,
        });
        return state;
      }
    ...
    case ADD_GEBREKEN:
      ...
      if (!["ernstig", "serieus", "gering"].includes(addCategoryMultiple)) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Onbekende categorie: ${addCategoryMultiple}`,
        });
        return state;
      }
      ...
      if (uniqueGebrekenToAddMultiple.length === 0) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Geen nieuwe gebreken om toe te voegen onder ${addCategoryMultiple}.`,
        });
        return state;
      }
    ...
    case ADD_GEBREKEN_TO_ELEMENT:
      ...
      if (!["ernstig", "serieus", "gering"].includes(addElCategoryMultiple)) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Onbekende categorie: ${addElCategoryMultiple}`,
        });
        return state;
      }
      ...
      const updatedGlobalElementsAdd = state.globalElements.map((element) => {
        if (element.id === elementId) {
          ...
          if (uniqueGebrekenToAddEl.length === 0) {
            ...
            dispatch({
              type: SET_ERROR_MESSAGE,
              payload: `Geen nieuwe gebreken om toe te voegen onder ${addElCategoryMultiple} voor dit element.`,
            });
            return element;
          }
    ...
    case REMOVE_GEBREKEN_FROM_ELEMENT:
      ...
      if (!["ernstig", "serieus", "gering"].includes(remElCategory)) {
        ...
        dispatch({
          type: SET_ERROR_MESSAGE,
          payload: `Onbekende categorie: ${remElCategory}`,
        });
        return state;
      }
