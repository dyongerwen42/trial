...
export const MjopProvider = ({ children }) => {
  ...
  const setNewSpace = (updatedFields) => {
  ...
  const setNewElement = (updatedFields) => {
  ...
  // **Regular async saveData function without useCallback**
  ...
  const updateGebreken = (category, gebrekenList) => {
  ...
  const addGebrek = (category, material, severityCategory, gebrekName) => {
  ...
  const removeGebrek = (category, material, severityCategory, gebrekName) => {
