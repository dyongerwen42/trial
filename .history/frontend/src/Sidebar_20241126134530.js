      ...
      {Object.entries(categorizedElements).map(([category, spaces]) => {
        ...
        return (
          ...
          >
            ...
            >
              {/* Checkbox met stopPropagation */}
              <Checkbox
                checked={isAllSelected}
                indeterminate={selected.length > 0 && !isAllSelected}
                onChange={() => toggleSelectAll(category)}
                sx={{ p: 0.5 }} // Kleinere padding voor compactheid
                color="secondary"
                onClick={(e) => e.stopPropagation()} // Voorkomt accordion toggle
              />
              {/* Titel */}
              <Typography
                variant="subtitle1"
                sx={{
                  ...
                  fontSize: '0.95rem',
                  color: '#1e293b',
                  flex: 1, // Zorgt dat de tekst consistent uitlijnt
                }}
              >
                {category}
              </Typography>
                          ...
                          action={
                            <Tooltip title="Details bekijken" arrow>
                              <IconButton
                                size="small"
                                onClick={(e) => {
                                  e.stopPropagation(); // Voorkomt accordion toggle
