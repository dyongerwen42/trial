...
const GlobalElements = () => {
  ...
  const handleTypeChange = (e) => {
    // Not needed anymore since type is removed
  };

  // Handle material change
  const handleMaterialChange = (e) => {
    // Not needed anymore since material is removed
  };
                  ...
                  return (
                    <React.Fragment key={uniqueKey}>
                      ...
                      {isExpanded && (
                        ...
                        >
                          {/* Gebreken types are no longer needed */}
                          {/* Instead, select the element for editing */}
                          <ListItem
                            button
                            onClick={() => handleSelectElement(element, true, false)}
                            sx={{
                              padding: "12px 20px",
