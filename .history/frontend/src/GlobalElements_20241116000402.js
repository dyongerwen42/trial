...
const GlobalElements = ({ t }) => {
  ...
  const handleSaveElement = useCallback(async () => { // Maak deze functie asynchroon
    const newErrors = {};
  ...
  }, [isEditing, newElement, handleEditElement, handleAddElement, state.globalElements, saveData, setErrors, setSuccessMessage, handleResetNewElement]);
