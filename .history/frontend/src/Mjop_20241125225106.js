...
const FullTaskManager = () => {
  ...
  const handleOpenTaskGroupInfoDialog = (group) => {
    ...
    setSelectedTaskGroupTab(0); // Reset to first tab when opening
  };
  ...
  return (
    <Box sx={{ position: 'relative', height: '100vh', backgroundColor: '#f4f6f8', p: 3 }}>
      ...
      >
        ...
        <DialogActions>
          <Box display="flex" justifyContent="flex-end" sx={{ width: '100%', pr: 2 }}>
            <Button
              variant="contained"
              color="primary"
