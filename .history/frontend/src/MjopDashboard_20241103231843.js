...
const MJOPDashboard = () => {
  ...
  const sections = {
    alles: [
      ...
      {
        title: "Inspecties",
        icon: <CalendarTodayIcon />, // Replace with a relevant icon if needed
        items: [
      ...
      {
        title: "Condities",
        icon: <FolderIcon />, // Replace with a relevant icon if needed
        items: [
      ...
      {
        title: "Meldingen",
        icon: <AssignmentIcon />, // Replace with a relevant icon if needed
        items: [
