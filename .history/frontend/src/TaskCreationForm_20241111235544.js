    ...
    selectedElements.forEach((element) => {
      ...
      selectedTasks.forEach((task, taskIndex) => {
        ...
        const newTask = {
          ...
          planned: {
            workDate: workDate ? workDate.toISOString() : null,
                ...
                <Accordion key={index} defaultExpanded>
                  ...
                  <AccordionDetails>
                    ...
                    <Grid container spacing={2} sx={{ mb: 2 }}>
                      <Grid item xs={6}>
                        <Typography variant="body1">Werkdatum (optioneel)</Typography>
                      ...
                      <Grid item xs={6}>
                        <Typography variant="body1">Einddatum (verplicht)</Typography>
                        <LocalizationProvider dateAdapter={AdapterDateFns}>
                          <DesktopDatePicker
                            views={['year', 'month']}
                            label="Einddatum"
