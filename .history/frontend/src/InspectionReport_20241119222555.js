...
const InspectionReport = ({ t }) => {
  ...
  const handleOpenModal = useCallback((elementId, inspection) => {
    ...
    setModalKey(prevKey => prevKey + 1); // Verhoog modalKey om remount te forceren
  }, [globalElements]);
  ...
  return (
    <Box display="flex" overflow="auto" flexDirection="column" width="100%" p={2} bgcolor="#f9fafb">
      ...
      >
        ...
        <AccordionDetails>
          <InspectionTable
            ...
            handleRequestInspectionForAll={/* Voeg de juiste functie toe */}
      ...
      {/* Inspection Modal met key prop */}
      {currentInspection && (
        <InspectionModal
          key={modalKey} // Voeg de key prop toe
