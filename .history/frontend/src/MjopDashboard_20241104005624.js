...
const MJOPDashboard = () => {
  ...
  sx={{
    mb: 2,
    borderColor: editMode ? 'primary.main' : 'secondary.main', // Change border color based on mode
    color: editMode ? 'primary.main' : 'secondary.main', // Text color matches the border color
    padding: '8px 16px', // Adjusted padding for a balanced look
    borderRadius: '10px', // Slightly rounded corners
    boxShadow: 'none', // Remove default shadow for a cleaner look
    transition: 'border-color 0.3s, color 0.3s, background-color 0.3s', // Smooth transitions
    '&:hover': {
      borderColor: editMode ? 'primary.dark' : 'secondary.dark', // Darker border color on hover
      color: 'white', // Change text color to white on hover
      bgcolor: editMode ? 'primary.main' : 'secondary.main', // Background color change on hover
    },
  }}
>
