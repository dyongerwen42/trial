...
const handleSelectElement = (element, isEditMode = false, fromTable = false) => {
  ...
  const renderStepContent = (step) => {
    switch (step) {
      import { Checkbox, ListItemText } from '@mui/material'; // Make sure to import these components for the multi-select functionality
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={6}>
                  <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
                    <InputLabel>Selecteer Categorieën</InputLabel>
                    <Select
                      multiple
