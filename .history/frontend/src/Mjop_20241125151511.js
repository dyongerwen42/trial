...
const FullTaskManager = () => {
  ...
  const totalCost = useMemo(() => {
    return taskGroups.reduce((acc, group) => acc + Number(group.cost || 0), 0);
  }, [taskGroups]);
          ...
          >
            ...
            >
              <TableContainer component={Paper} sx={{ maxHeight: '60vh' }}>
                <Table stickyHeader aria-label="taak tabel">
                  <TableHead>
                    <TableRow>
                      <TableCell>Taaknaam</TableCell>
                      <TableCell>Beschrijving</TableCell>
                      <TableCell>Urgentie</TableCell>
                      <TableCell>Geschatte Prijs (€)</TableCell>
                      <TableCell>Ultimate Datum</TableCell>
                    </TableRow>
                  </TableHead>
                  <TableBody>
