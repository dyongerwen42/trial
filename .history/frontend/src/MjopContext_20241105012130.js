...
const initialState = {
  generalInfo: { /* initial general info fields */ },
  cashInfo: { /* initial cash info fields */ },
  mjop: {},
  globalElements: [],
  globalSpaces: [],
  globalDocuments: [],
...
export const MjopProvider = ({ children }) => {
  ...
  const contextValue = useMemo(() => ({
    ...
    setGeneralInfo,
    setGlobalSpaces,
  }), [state, saveData, calculateCurrentCashValue, getSaldoColorValue]);
