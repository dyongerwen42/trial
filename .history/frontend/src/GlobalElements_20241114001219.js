...
const GlobalElements = ({ t }) => {
  ...
  const calculateTotalPrice = () => {
    const quantity = parseFloat(newElement.quantity) || 0;
    let unitPrice = 0;
    if (newElement.unitType === "vierkante_meter") {
      unitPrice = newElement.prices.prijs_per_vierkante_meter || 0;
    } else if (newElement.unitType === "strekkende_meter") {
      unitPrice = newElement.prices.prijs_per_strekkende_meter || 0;
    } else if (newElement.unitType === "stuk") {
      unitPrice = newElement.prices.prijs_per_stuk || 0;
    }
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth variant="outlined" sx={{ mb: 2 }}>
                <InputLabel>Selecteer soort werkzaamheden</InputLabel>
                <Select
                  multiple
            ...
            <Grid item xs={12} md={6}>
              <FormControl
                ...
                sx={{ mb: 2 }}
              >
                <InputLabel>Selecteer Eenheid</InputLabel>
                <Select
                  value={newElement.unitType}
                  onChange={(e) =>
                    setNewElement({ ...newElement, unitType: e.target.value })
                  }
                  label="Selecteer Eenheid"
                >
                  {newElement.prices.prijs_per_vierkante_meter > 0 && (
                    <MenuItem value="vierkante_meter">Vierkante meter</MenuItem>
                  )}
                  {newElement.prices.prijs_per_strekkende_meter > 0 && (
                    <MenuItem value="strekkende_meter">
                      Strekkende meter
                    </MenuItem>
                  )}
                  {newElement.prices.prijs_per_stuk > 0 && (
            ...
            <Grid item xs={12} md={6}>
              <Typography variant="body1">
                <strong>Totaalprijs:</strong> €{calculateTotalPrice()}
              </Typography>
            </Grid>
