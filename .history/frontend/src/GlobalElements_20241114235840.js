            ...
            <Grid item xs={12}>
              ...
              {currentGebreken.customCategory && (
                <Box mt={4}>
                  ...
                  <Grid container spacing={1}>
                    {currentGebreken.customCategory.map((gebrek, index) => (
                      <Grid item xs={12} sm={6} md={4} key={index}>
                        <Box display="flex" alignItems="center">
                          <FormControlLabel
                            control={
