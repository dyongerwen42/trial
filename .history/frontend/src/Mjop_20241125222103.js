                      ...
                      <Box key={spaceName} sx={{ mb: 3 }}>
                        ...
                        {elements.map((element) => {
                          ...
                          const plannedYears = useMemo(
                            ...
                            [element.tasks, taskGroupsMap, category]
                          );
        ...
        <DialogContent dividers>
          <Box component="form" noValidate autoComplete="off">
            ...
            <TextField
              ...
              InputProps={{
                startAdornment: (
                  <AssignmentIcon fontSize="small" sx={{ mr: 1, color: '#1976d2' }} />
                ),
              }}
            />
            <FormControlLabel
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  {currentElementInfo.tasks.map((task) => (
                    <Card key={task.id} variant="outlined" sx={{ mb: 2 }}>
                      <CardHeader
                        avatar={
                          <Avatar sx={{ bgcolor: '#2196f3', width: 30, height: 30 }}>
                            <AssignmentIcon fontSize="small" />
                          </Avatar>
                        }
                        title={
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  {currentElementInfo.annotations.map((annotation, idx) => (
                    <Box key={idx} sx={{ mb: 1 }}>
                      ...
                      <Typography variant="body2">
                        x: {annotation.x.toFixed(3)}, y: {annotation.y.toFixed(3)}, width:{' '}
                        {annotation.width.toFixed(3)}, height: {annotation.height.toFixed(3)}
                      </Typography>
                    </Box>
                  ))}
                </Box>
