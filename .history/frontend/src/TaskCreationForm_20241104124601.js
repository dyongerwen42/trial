...
import { useMjopContext } from './MjopContext'; // Make sure to adjust the path to your context file

import React, { useState, useEffect } from 'react';
import { v4 as uuidv4 } from 'uuid';
import { addDays, addYears } from 'date-fns'; // Make sure you have date-fns installed
import { useMjopContext } from './MjopContext';

const TaskCreationForm = () => {
  const {
    globalSpaces = [], // Default to empty array if undefined
    globalElements = [], // Default to empty array if undefined
    setGlobalElements,
    setGlobalSpaces,
  } = useMjopContext();
