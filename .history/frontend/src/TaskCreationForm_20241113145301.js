...
const TaskCreationForm = () => {
  ...
  const handleAddTask = useCallback(() => {
    ...
    selectedElements.forEach((element) => {
      ...
      selectedTasks.forEach((task, taskIndex) => {
        ...
        let newStartDate = task.adjustments.startDate || startDate;
        let durationDays = task.adjustments.durationDays
          ? parseInt(task.adjustments.durationDays)
          : customTask.durationDays
          ? parseInt(customTask.durationDays)
          : 0;
              ...
              <AccordionDetails>
                <Grid container spacing={2}>
                  <Grid item xs={12} md={6}>
                    ...
                    <DatePicker
                      selected={task.adjustments.startDate || startDate}
                    ...
                    <TextField
                      ...
                      type="number"
                      label="Duur in dagen"
                      value={task.adjustments.durationDays || customTask.durationDays}
                      onChange={(e) =>
                        handleTaskAdjustment(index, 'durationDays', e.target.value)
                      }
                      variant="outlined"
                      size="medium"
                    />
  ...
  const Step3ReviewConfirm = () => {
    return (
      <CardContent>
        {/* Voeg hier de code voor stap 3 toe */}
      </CardContent>
    );
  };
            ...
            <List subheader={<li />}>
              {Array.from(
                ...
                <li key={`section-${category}`}>
                  <ul style={{ padding: 0 }}>
                    <ListSubheader>{`Categorie: ${category}`}</ListSubheader>
                      ...
                      return (
                        ...
                        >
                          ...
                          <ListItemText
                            ...
                            secondary={`Toelichting: ${task.toelichting || 'Geen'}`}
