...
import AlgemeneInformatie from "./edit/AlgemeneInformatie"; // Import the edit component
...
const MJOPDashboard = () => {
  ...
  const { state, dispatch, saveData } = useMjopContext();
            ...
            >
              ...
              {editMode ? (
                <AlgemeneInformatie
                  ...
                  setGeneralInfo={(newInfo) => dispatch({ type: 'SET_DATA', payload: { generalInfo: newInfo } })}
                  errors={errors}
                />
              ) : (
