...
const GlobalElements = ({ t }) => {
  ...
  const handleAddCustomGebrek = () => {
    ...
    const severity = "custom"; // You can choose how to categorize custom gebreken
    const category = "customCategory"; // You can choose how to categorize custom gebreken

    const updatedGebreken = { ...newElement.gebreken };

    if (!updatedGebreken[severity]) {
      updatedGebreken[severity] = [];
    }

    updatedGebreken[severity].push(customGebrek.trim());

    updateGebreken(severity, updatedGebreken[severity]);
