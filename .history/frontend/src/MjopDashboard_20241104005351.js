      ...
      >
        <Grid container spacing={3} sx={{ width: "100%", m: 0, p: 0 }}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              <Button
  variant="contained" // Use contained variant for a more modern look
  onClick={toggleEditMode}
  sx={{
    mb: 2,
    bgcolor: editMode ? 'primary.main' : 'secondary.main', // Change color based on mode
    color: '#fff',
    borderRadius: '8px',
    padding: '10px 20px', // Increase padding for a more substantial feel
    boxShadow: 2,
    transition: 'background-color 0.3s, transform 0.3s',
    '&:hover': {
      bgcolor: editMode ? 'primary.dark' : 'secondary.dark', // Darker color on hover
      transform: 'scale(1.02)', // Slightly scale up on hover
      boxShadow: 4, // Increase shadow on hover for depth
    },
    fontWeight: 'bold', // Make the font bold for emphasis
    textTransform: 'capitalize', // Capitalize the text for consistency
  }}
>
