...
const GlobalElements = ({ t }) => {
  ...
  const handleSelectElement = (
    ...
    // Update the context's newElement via `setNewElement`
    setNewElement({
  ...
  const handleMaterialChange = (e) => {
    ...
    const gebreken = extractGebreken(
      newElement.name,
      newElement.type,
      selectedMaterial,
      inspectionTasks
  ...
  useEffect(() => {
    if (globalElements.length > 0) { // Gebruik direct 'globalElements' in plaats van 'state.globalElements'
  ...
  }, [globalElements, saveData, setErrors]); // Gebruik direct 'globalElements'
  ...
  const handleSelectGebrek = (category, gebrekName) => {
    ...
    if (updatedGebreken[category].includes(gebrekName)) {
      updatedGebreken[category] = updatedGebreken[category].filter(
        (g) => g !== gebrekName
      );
    } else {
      updatedGebreken[category].push(gebrekName);
    }
  ...
  const handleAddCustomGebrek = () => {
    ...
    const severity = "custom"; // Je kunt kiezen hoe je aangepaste gebreken wilt categoriseren
    const category = "customCategory"; // Je kunt kiezen hoe je aangepaste gebreken wilt categoriseren
    ...
    updatedGebreken[category].push(customGebrek.trim());
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              ...
                              onChange={() => handleSelectGebrek(category, gebrek)}
                            />
                          }
                          label={gebrek}
                        />
                        ...
                        <FormControlLabel
                          control={
                            <Checkbox
                              checked={true}
                              onChange={() =>
                                handleSelectGebrek("customCategory", gebrek)
                              }
                            />
                          }
                          label={gebrek}
