...
import AlgemeneInformatie from "./edit/AlgemeneInformatie"; // Import edit component
...
const MJOPDashboard = () => {
  ...
  const toggleEditMode = () => setEditMode((prevMode) => !prevMode); // Toggle function
  ...
  const sections = {
    ...
    // Additional tabs like overzichten and beheer ...
  };
        ...
        <Grid container spacing={3} sx={{ width: "100%", m: 0, p: 0 }}>
          ...
          <Grid item xs={12} md={6}>
            ...
            >
              ...
              {editMode ? (
                <AlgemeneInformatie generalInfo={generalInfo} />
              ) : (
