...
// Haal alle prijzen-gerelateerde functies en logica weg
...
const GlobalElements = ({ t }) => {
  ...
  // Verplaats handleResetNewElement naar boven en verwijder prijzen-gerelateerde code
  ...
  // Definieer de functie om elementen op te slaan zonder prijzen
  ...
  // Definieer de navigatiefuncties voor de Stepper met useCallback
  ...
  // Definieer de functie om te controleren of alle vereiste velden zijn ingevuld
  ...
  // Definieer de modal handlers met useCallback
  ...
  // Define table columns zonder prijzen
  const columns = useMemo(
    ...
    [globalSpaces, handleDeleteElement, handleOpenDocumentsModal, handleOpenPhotosModal, handleSelectElement]
  );
  ...
  const handleSelectElement = useCallback((element, isEditMode = false, fromTable = false) => {
    ...
    // Verwijder prijzen-gerelateerde code
  ...
  const handleSelectGebrek = useCallback((category, severity, material, gebrekName) => {
  ...
  }, [newElement, addGebrek, removeGebrek]);
  ...
  const handleAddCustomGebrek = useCallback(() => {
    ...
    setCustomGebrek("");
    setCustomGebrekSeverity("gering");
  }, [customGebrek, customGebrekSeverity, newElement.type, newElement.material, addGebrek]);
  ...
  }, [newElement, customGebreken, handleSelectGebrek]);
