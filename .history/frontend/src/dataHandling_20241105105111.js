...
export const saveMJOPData = async (id, formData, config, navigate) => {
  try {
    ...
    console.log("Payload being sent to the server:", JSON.stringifypayload);
    ...
    throw new Error('Error saving MJOP data'); // Throw error to be handled by calling function
  }
};
