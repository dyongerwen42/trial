  ...
  switch (action.type) {
    ...
    case "REMOVE_GEBREK":
      ...
      if (
        ...
        !state.newElement.gebreken[removeCategory][removeMaterial][removeSeverity]
      ) {
        console.warn(`Gebrek "${removeGebrekName}" niet gevonden onder ${removeSeverity}.`);
        return state;
      }

      const updatedSeverityList = state.newElement.gebreken[removeCategory][removeMaterial][removeSeverity].filter(
      ...
      const updatedGebreken = {
        ...
        [removeCategory]: {
          ...
          [removeMaterial]: {
            ...state.newElement.gebreken[removeCategory][removeMaterial],
            [removeSeverity]: updatedSeverityList,
          },
        },
      };
      ...
      if (updatedSeverityList.length === 0) {
        delete updatedGebreken[removeCategory][removeMaterial][removeSeverity];
      }
    ...
    case "ADD_INSPECTION_REPORT":
      return {
        ...
        newElement: {
          ...state.newElement,
          inspectionReport: [
            ...state.newElement.inspectionReport,
            {
              id: uuidv4(),
              description: "",
              inspectionDone: false,
    ...
    case "UPDATE_INSPECTION_REPORT":
      return {
        ...
        newElement: {
          ...state.newElement,
          inspectionReport: state.newElement.inspectionReport.map((report) =>
    ...
    case "REMOVE_INSPECTION_REPORT":
      return {
        ...
        newElement: {
          ...state.newElement,
          inspectionReport: state.newElement.inspectionReport.filter(
...
export const MjopProvider = ({ children }) => {
  ...
  // Functie om gebreken te updaten
