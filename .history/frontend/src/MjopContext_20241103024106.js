...
const initialState = {
    ...
    cashInfo: {
      currentCash: 0,            // Default value to avoid undefined errors
      monthlyContribution: 0,     // Default value for monthly contribution
      reserveDate: new Date(),    // Default to the current date to avoid undefined dates
      totalWorth: 0,              // Default total worth to avoid undefined errors
    },
    mjop: {},                      // Default empty object for MJOP data
    globalElements: [],            // Default empty array for global elements
    globalSpaces: [],              // Default empty array for global spaces
    globalDocuments: [],           // Default empty array for global documents
    offerGroups: [],               // Default empty array for offer groups
    isSaving: false,               // Default to false for saving state
    errors: {},                    // Default empty object for error messages
    success: null,                 // Default to null for success state
    tabErrors: {
      generalInfo: false,          // Default error states for individual tabs
      cashInfo: false,
      globalSpaces: false,
    ...
    openErrorDialog: false,        // Default dialog state for error messages
    errorMessage: '',              // Default empty string for error message
  };
  ...
  return (
    <MjopContext.Provider
      value={{
        ...
        getSaldoColor,
        addTaskToPlanning,
        setOfferGroups,      // Provide setOfferGroups to the context
        setGlobalElements,   // Provide setGlobalElements to the context
      }}
    >
      {children}
    </MjopContext.Provider>
