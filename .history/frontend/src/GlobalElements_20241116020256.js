              ...
              >
                ...
                >
                  {Object.keys(
                    ...
                    <MenuItem key={`${newElement.id}-${type}`} value={type}>
                      {type}
                    </MenuItem>
                  ))}
                </Select>
              ...
              >
                ...
                >
                  {materials.map((material) => (
                    <MenuItem key={`${newElement.id}-${material}`} value={material}>
                      {material}
                    </MenuItem>
                  ))}
                  <MenuItem key={`${newElement.id}-Other`} value="Other">Overig</MenuItem>
                </Select>
                {errors.material && (
        ...
        >
          ...
          <List>
            {filteredElements.map((element, index) => {
              ...
              return (
                <React.Fragment key={`${element.id || `element-${index}`}`}>
                  <ListItem
                    button
                  ...
                  {isExpanded && (
                    ...
                    >
                      {Object.keys(
                        ...
                        <ListItem
                          button
                          key={`${element.id || `element-${index}`}-type-${type}-${typeIndex}`}
                          onClick={() =>
