...
const FullTaskManager = () => {
  ...
  const addOrUpdateTaskGroup = useCallback(() => {
    ...
    if (dialogMode === 'add') {
      if (periodic) {
        ...
        // Update globalElements na het verzamelen van alle taken
      ...
      // This seems like a syntax error in the original code. Ensure proper closing of conditionals
      // I believe the following part should be in an 'else' or separate condition
      // Assuming it's a separate condition for non-periodic tasks
  ...
  // Removed the loader spinner block
