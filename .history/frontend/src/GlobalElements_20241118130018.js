...
const GlobalElements = ({ t }) => {
  ...
  const extractGebreken = useCallback(
    (
      elementName,
      type,
      material,
  ...
  const handleSelectElement = useCallback(
    ...
    [extractGebreken, globalSpaces, newElement.gebreken, errors, setErrors, setNewElement]
  );
  ...
  const handleMaterialChange = useCallback(
    ...
    [newElement.type, newElement.material, newElement.gebreken, setNewElement]
  );
  ...
  }, [newElement, addGebrek, removeGebrek, theme.palette, errors, extractGebreken]);
