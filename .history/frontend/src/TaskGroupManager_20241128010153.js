...
import TaskGroupDialog from './Dialogs/TaskGroupDialog';
  ...
  const addOrUpdateTaskGroup = useCallback(() => {
    ...
    if (dialogMode === 'add') {
      if (periodic) {
        ...
        // ... (similar logic as above for non-periodic tasks)
        // For brevity, this part is omitted but should follow similar patterns.
      }
  }, [
    dialogMode,
    taskProperties,
