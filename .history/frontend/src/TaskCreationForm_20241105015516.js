...
const TaskCreationForm = () => {
  ...
  const handleAddTask = useCallback(() => {
    ...
    // Dispatching the new tasks to the state with the correct elementId
    dispatch({
      type: 'ADD_TASK',
      payload: { elementId: selectedElement, tasks: tasksToAdd },
    });
  
    // Saving to the database
    saveData();
  
    console.log("Tasks added and saved to the database:", tasksToAdd);
    resetForm();
  }, [
    customTask,
    globalElements,
