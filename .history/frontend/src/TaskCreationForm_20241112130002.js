  ...
  const handleAddTask = useCallback(() => {
    ...
    selectedElements.forEach((element) => {
      ...
      selectedTasks.forEach((task, taskIndex) => {
        ...
        if (task.adjustments.setDirectToWorkDate) {
          newWorkDate = new Date(task.adjustments.workDate);
          newEndDate = new Date(task.adjustments.workDate);
        }

        if (task.adjustments.customEndDate) {
      ...
      case 0:
        ...
        return (
          <CardContent>
            ...
            {/* Date Pickers for Start Date and Ultimate Date */}
            <Box sx={{ mb: 3 }}>
                  ...
                  <AccordionDetails>
                    ...
                    {!task.adjustments.setDirectToWorkDate && (
                      <Box sx={{ mt: 2 }}>
                        ...
                        <DatePicker
                          selected={task.adjustments.endDate || addDays(startDate, customTask.durationDays || 0)}
                          onChange={(date) =>
