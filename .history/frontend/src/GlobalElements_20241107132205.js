...
const handleSelectElement = (element, isEditMode = false, fromTable = false) => {
  ...
  const handleSaveElement = async () => {
    ...
    // For example, uncomment only if fields should be required:
    ...
    // Check for errors and set form feedback if any are found
    ...
    // Save the element data to the backend after modifying it
    await saveData();
