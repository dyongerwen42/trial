  ...
  const addOrUpdateTaskGroup = useCallback(() => {
    ...
    if (dialogMode === 'add') {
      if (periodic) {
        ...
        // Handle non-periodic task group addition here (assuming this part was incomplete in your original code)
        // Add your logic for non-periodic task group addition
        // For brevity, let's assume it's similar to the periodic case without the loops
      }
        // Validation
        if (!groupDate) {
