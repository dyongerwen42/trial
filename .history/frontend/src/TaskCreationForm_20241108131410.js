...
const TaskCreationForm = () => {
  ...
  // State variables
  const [selectedTaskType, setSelectedTaskType] = useState(""); // <-- Added this line
  ...
  const resetForm = useCallback(() => {
    ...
    setEndDate(new Date());
    setSelectedTaskType(""); // <-- Reset the task type as well
  }, []);
