...
const AlgemeneInformatie = ({ generalInfo, setGeneralInfo, errors }) => {
  ...
  <Box
    sx={{
      ...
      borderRadius: '8px',
      overflow: 'hidden',
      boxShadow: 3, // Verhoogde schaduw voor diepte
      transition: 'box-shadow 0.3s, transform 0.3s',
      '&:hover': {
        boxShadow: 6, // Verhoog schaduw op hover
        transform: 'scale(1.02)', // Iets vergroten bij hover
      },
    }}
  >
    <img
    ...
    <Box
      ...
      sx={{
        width: '100%',
        backgroundColor: 'rgba(255, 255, 255, 0.9)', // Meer transparant wit voor betere zichtbaarheid
        borderTop: '1px solid #ccc', // Lichte scheidingslijn
        p: 1,
      }}
    >
      <IconButton
        ...
        sx={{
          ...
          '&:active': {
            transform: 'scale(0.95)', // Kleinere schaling bij indrukken
          },
        }}
      >
        <DownloadIcon />
