...
import {
  ...
  Edit as EditIcon,
  Info as InfoIcon, // Toegevoegd voor Info-popup
...
const FullTaskManager = () => {
  ...
  // Handle Info Dialog Open for Elements
                  ...
                  <ListItemSecondaryAction>
                    <Tooltip title="Bekijk elementen" arrow>
                      <IconButton
                        ...
                        onClick={() => handleOpenTaskGroupInfoDialog({
                          name: category,
                          elements: filteredCategorizedElements[category],
                        })}
                      >
                        <InfoOutlinedIcon />
                      </IconButton>
                            ...
                            <CardHeader
                              ...
                              action={
                                <Tooltip title="Bekijk details" arrow>
                                  <IconButton aria-label="info" onClick={() => handleOpenTaskGroupInfoDialog(group)}>
                                    <InfoIcon />
                                  </IconButton>
                                </Tooltip>
                              }
