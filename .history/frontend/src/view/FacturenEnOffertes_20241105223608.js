...
const InvoiceDashboard = () => {
  ...
  return (
    <Box sx={{ p: 4, maxWidth: '95vw', margin: '0 auto', bgcolor: theme.palette.background.default }}>
      ...
      <Grid container spacing={4} sx={{ mb: 4 }}>
        {[
          ...
          <Grid item xs={12} sm={6} md={2.4} key={label}>
            ...
            >
              <Typography variant="h6" sx={{ fontWeight: 'bold', color: theme.palette.text.primary, mb: 1 }}>{label}</Typography>
      ...
      <Grid container spacing={4} sx={{ mb: 4 }}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 3, boxShadow: theme.shadows[4], borderRadius: 3, height: 300 }}>
      ...
      <TableContainer component={Paper} sx={{ borderRadius: 3, boxShadow: theme.shadows[4], mb: 4 }}>
        <Table>
