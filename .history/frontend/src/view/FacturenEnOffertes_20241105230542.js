    ...
    <Box sx={{ p: 6, maxWidth: '95vw', margin: '0 auto', bgcolor: theme.palette.background.default }}>
      ...
      <Grid container spacing={4} sx={{ mb: 6 }}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 4, boxShadow: theme.shadows[10], borderRadius: 3, height: 350, maxHeight: 350 }}>
        ...
        <Grid item xs={12} md={3}>
          <Paper sx={{ p: 4, boxShadow: theme.shadows[10], borderRadius: 3, height: 350, maxHeight: 350, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
