    ...
    <Box sx={{ p: 6, maxWidth: '95vw', margin: '0 auto', bgcolor: theme.palette.background.default }}>
      ...
      <Grid container spacing={4} sx={{ mb: 6 }}>
        <Grid item xs={12} md={6}>
          <Paper sx={{ p: 4, boxShadow: theme.shadows[10], borderRadius: 3, height: 320 }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold', textAlign: 'center', color: theme.palette.primary.main }}>Balans Trend</Typography>
        ...
        <Grid item xs={12} md={3}>
          <Paper sx={{ p: 4, boxShadow: theme.shadows[10], borderRadius: 3, height: 320, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold', textAlign: 'center', color: theme.palette.primary.main }}>Betaalstatus</Typography>
            <Box sx={{ maxHeight: 280, overflow: 'hidden' }}>
        ...
        <Grid item xs={12} md={3}>
          <Paper sx={{ p: 4, boxShadow: theme.shadows[10], borderRadius: 3, height: 320 }}>
            <Typography variant="h6" sx={{ mb: 2, fontWeight: 'bold', textAlign: 'center', color: theme.palette.primary.main }}>Niet Betaalde Facturen per Maand</Typography>
            <Box sx={{ maxHeight: 280, overflow: 'hidden' }}>
              ...
              <TableRow key={index} sx={{ '&:hover': { bgcolor: theme.palette.action.hover, transition: 'background-color 0.3s' } }}>
                ...
                <TableCell sx={{ borderBottom: '1px solid #e0e0e0', padding: '18px', textAlign: 'center' }}>
                  <Tooltip title="Download">
                    <IconButton href={`http://34.34.100.96:5000/${invoice.file}`} target="_blank" color="primary">
                      <DescriptionIcon />
                    </IconButton>
                  </Tooltip>
                </TableCell>
