                    ...
                    >
                            ...
                            {Array.isArray(mistake.images) && mistake.images.map((image, imageIndex) => (
                              ...
                              >
                                ...
                                <IconButton
                                  ...
                                  aria-label={`clear image ${imageIndex + 1}`}
                                >
                                  <ClearIcon />
                                </IconButton>
                      ...
                      >
                        <IconButton
                          ...
                          aria-label={`delete mistake ${index + 1}`}
                        >
                          <DeleteIcon />
                        </IconButton>
                      </Grid>
                    ...
                    <Grid item xs={12}>
                      <FormControl fullWidth>
                        <Button
                          ...
                          startIcon={<AddPhotoAlternateIcon />}
                          sx={{ mb: 2 }}
                          aria-label={`upload photos task ${index + 1}`}
                        >
                          Upload Foto
                          <input
                            type="file"
                    ...
                    <Grid item xs={12}>
                      <FormControl fullWidth>
                        <Button
                          ...
                          startIcon={<InsertDriveFileIcon />}
                          sx={{ mb: 2 }}
                          aria-label={`upload documents task ${index + 1}`}
                        >
                          Upload Documenten
                          <input
                            type="file"
                            ...
                            return (
                              ...
                              >
                                <a
                                  ...
                                  download
                                  style={{ margin: "0 8px" }}
                                  aria-label={`download task document ${index + 1}`}
                                >
                                  {icon}
                                </a>
                                <Box display="flex" justifyContent="center" mt={1}>
                                  ...
                                  <IconButton
                                    ...
                                    aria-label={`clear task document ${index + 1}`}
                                  >
                                    <ClearIcon />
                                  </IconButton>
                                </Box>
