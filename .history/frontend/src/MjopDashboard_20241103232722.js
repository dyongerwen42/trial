...
import ReceiptLongIcon from "@mui/icons-material/ReceiptLong";
import PolicyIcon from "@mui/icons-material/Policy";
import NatureIcon from "@mui/icons-material/Nature"; // Replacing EcoIcon with NatureIcon
...
const MJOPDashboard = () => {
  ...
  const sections = {
    alles: [
      ...
      {
        title: "Verduurzaming",
        icon: <NatureIcon />, // Replacing EcoIcon with NatureIcon for sustainability
        items: [
