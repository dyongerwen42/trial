...
const MJOPDashboard = () => {
  ...
  const sections = {
    ...
    beheer: [
      { title: "MJOP", items: [{ label: "Plan taken", path: "/planning" }] },
      {
        title: "Onderhoudsmanagement",
        items: [{ label: "Kanban bord planning", path: "/planning" }, { label: "Planning table", path: "/planning" }],
      },
      {
        title: "Inventarisatie",
        items: [{ label: "Ruimtes / Objecten", path: "/spaces" }, { label: "Elementen", path: "/elements" }, { label: "Levensduur overzicht", path: "/lifespan" }],
      },
      { title: "Inspecties", items: [{ label: "Inspectie planning", path: "/inspection-report" }] },
      { title: "Verduurzaming", items: [{ label: "Verduurzamings management", path: "/sustainability" }] },
      { title: "Financieel", items: [{ label: "Contracten beheer", path: "/contracts" }] },
    ],
  };
