                ...
                <Accordion key={index} defaultExpanded>
                  ...
                  <AccordionDetails>
                    ...
                    <FormControlLabel
                      control={
                        <Checkbox
                          checked={task.adjustments.setWorkDate || false}
                          onChange={(e) =>
                            handleTaskAdjustment(index, 'setWorkDate', e.target.checked)
                          }
                        />
                      }
                      label="Stel werkdatum in"
                    />
                    {task.adjustments.setWorkDate && (
                      <Box sx={{ mb: 2 }}>
                    ...
                    <DatePicker
                      selected={task.adjustments.endDate || null}
