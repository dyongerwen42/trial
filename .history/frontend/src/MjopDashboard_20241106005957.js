    ...
    alles: [
      {
        ...
        items: [
          ...
          { label: "Meerjaren Onderhoudsplan", path: "/plan" },
      ...
      },
      {
        ...
        items: [{ label: "kanban bord", path: "/calendar" },{ label: "Kalender", path: "/calendar" }],
      },
      {
      ...
      },
      {
        ...
        icon: <FactCheckIcon />,
        items: [
          { label: "Inspectie overzicht", path: "/inspection-report" },
      ...
      },
      {
        ...
        items: [
          { label: "Meldingen", path: "/meldingen" },
