  ...
  const renderStepContent = (step) => {
    switch (step) {
      case 0:
        return (
          <Grid container spacing={2}>
            {/* Fields for Step 1: Element Details */}
      ...
      case 1:
        return (
          <Grid container spacing={2}>
            {/* Fields for Step 2: Ruimte Selectie */}
            <Grid item xs={12} md={6}>
              <FormControl
                fullWidth
                variant="outlined"
      ...
      case 2:
        return (
          <Grid container spacing={2}>
            {/* Fields for Step 3: Bestanden Uploaden */}
            <Grid item xs={12} md={6}>
      ...
      case 3:
        return (
          <Grid container spacing={2}>
            {/* Fields for Step 4: Gebreken & Inspecties */}
            {selectedImage && (
              <Grid item xs={12}>
                <Box sx={{ mt: 4 }}>
      ...
      case 4:
        return (
          <Grid container spacing={2}>
            {/* Fields for Step 5: Review & Opslaan */}
            <Grid item xs={12}>
            ...
            {newElement.vervangingsKosten && (
              <Grid item xs={12} md={6}>
                <Typography variant="body1">
                  <strong>Vervangings Kosten:</strong> €
                  {newElement.vervangingsKosten}
                </Typography>
              </Grid>
            )}

            {newElement.categories && newElement.categories.length > 0 && (
              <Grid item xs={12}>
                <Typography variant="body1">
                  <strong>Categorieën:</strong>{" "}
                  {newElement.categories.join(", ")}
                </Typography>
              </Grid>
            )}
