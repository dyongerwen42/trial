        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Box display="flex" flexDirection="row" flexWrap="wrap" gap={2} mb={2}>
            {photos.map((photo, index) => (
              ...
              >
                <img
                  src={`http://34.34.100.96:5000/${photo}`}
        ...
        <Box sx={{ mb: 3 }}>
          ...
          <Box display="flex" flexDirection="column" gap={1}>
            {documents.map((document, index) => (
              ...
              >
                <a
                  href={`http://34.34.100.96:5000/${document}`}
                  download
                  target="_blank"
                ...
                <IconButton
                  ...
                  onClick={() => {
                    ...
                    link.href = `http://34.34.100.96:5000/${document}`;
                      ...
                      <Box sx={{ mb: 3 }}>
                        ...
                        {task.planned?.offerFiles &&
                          task.planned.offerFiles.map((file, fileIndex) => (
                            ...
                            >
                              <a
                                href={`http://34.34.100.96:5000/${file}`}
                                download
                                target="_blank"
                                rel="noopener noreferrer"
                                style={{
                              ...
                              <IconButton
                                ...
                                onClick={() => {
                                  const link = document.createElement("a");
                                  link.href = `http://34.34.100.96:5000/${file}`;
                                  link.download = file;
                                  link.click();
                                }}
                              >
