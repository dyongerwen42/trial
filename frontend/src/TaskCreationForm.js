                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} sm={6}>
                    ...
                    <Typography variant="body1">
                      ...
                      {el.aanschafDatum
                        ? new Date(el.aanschafDatum).toLocaleDateString()
                        : 'N/A'}
                    </Typography>
                    <Typography variant="body1">
              ...
              <Table stickyHeader>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="center">Urgentie</TableCell>
                    <TableCell align="center">Startdatum</TableCell>
                    <TableCell align="center">Einddatum</TableCell>
                  ...
                  return (
                    <Accordion key={taskIndex} defaultExpanded sx={{ mb: 2 }}>
                      ...
                      <AccordionDetails>
                        ...
                        {/* Hier kun je aanvullende velden toevoegen zoals interval, contract, etc., vergelijkbaar met eerdere voorbeelden */}
                      </AccordionDetails>
                    </Accordion>
                  );
                })}
              ...
              <Table stickyHeader>
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell>Element</TableCell>
                    <TableCell>Ruimte</TableCell>
                    <TableCell align="center">Geschatte Prijs (€)</TableCell>
                    <TableCell align="center">Startdatum</TableCell>
                    <TableCell align="center">Werkdatum</TableCell>
                    <TableCell align="center">Einddatum</TableCell>
                    <TableCell>Commentaar</TableCell>
                    <TableCell align="center">Contractkosten (€)</TableCell>
                    <TableCell align="center">Contractduur (jaren)</TableCell>
                  </TableRow>
                </TableHead>
                <TableBody>
                  {selectedElements.map((element) => {
                    ...
                    return selectedTasks.map((task, taskIndex) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <TableCell align="center">€ {estimatedPrice}</TableCell>
                          <TableCell align="center">
                            {offerAccepted
                          ...
                          <TableCell align="center">{newEndDate.toLocaleDateString()}</TableCell>
